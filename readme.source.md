...
{ASCII}
        ...
        */}
        <style>{`
          ...
          #aura-cursor-halo  { animation: haloBlink 1s steps(2) infinite; transform-origin: 167px 1286px; }
        ...
        <svg width="900" height="1311" viewBox="0 0 900 1311" xmlns="http://www.w3.org/2000/svg" style={{ position: 'absolute', top: 0, left: 0 }}>
          ...
          <ellipse id="aura-cursor-halo" cx="167" cy="1286" rx="14" ry="11" fill="url(#aura-halo-grad)" />
          <rect id="aura-cursor" x="163" y="1278" width="9" height="14" fill={t.green} />
          ...
          */}
          ...
          <rect id="curt-log-pre"     x="0"   y="1058" width="167" height="22"  fill={t.termBg} />
          <rect id="curt-log-cmd"     x="167" y="1058" width="160" height="22"  fill={t.termBg} />
          <rect id="typing-cur-lg"    x="167" y="1062" width="8"   height="14"  fill={t.green} opacity="0" />
          <rect id="curt-log-out"     x="0"   y="1080" width="900" height="121" fill={t.termBg} />

          {/* ping --connect: 14 chars → cmd_w=112 */}
          <rect id="curt-ping-pre"    x="0"   y="1211" width="167" height="22"  fill={t.termBg} />
          <rect id="curt-ping-cmd"    x="167" y="1211" width="112" height="22"  fill={t.termBg} />
          <rect id="typing-cur-pg"    x="167" y="1215" width="8"   height="14"  fill={t.green} opacity="0" />
          <rect id="curt-ping-out"    x="0"   y="1233" width="900" height="28"  fill={t.termBg} />

          {/* Final cursor line (covers existing aura-cursor + halo until pingOut+500ms) */}
          <rect id="curt-cursor-line" x="0"   y="1263" width="900" height="40"  fill={t.termBg} />
        </svg>
      </div>
    </div>
  );
